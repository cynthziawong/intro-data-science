...
Students are also invited to join their cohort’s Slack channel, where they meet their future
classmates, instructors, and get support on pre-work assignments.
...
o Boosting-Through the Example of LSBoost
o Gradient Boosting
...
CountVectorizer
TF-IDF
o Predicting Methods: Naive Bayes Classifiers
o Topic Modeling:
...
• Machine Learning Theory Defense
• SQL Code Challenge
From the beginning of Bootcamp, you will work on hands-on projects. Now your Capstone Project lets
you create your own data product that showcases your interests and talents. Students are free to use
anything covered in class on this project.
